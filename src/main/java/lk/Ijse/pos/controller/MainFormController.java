...
public class MainFormController {
    ...
    private void navigate(MouseEvent event) throws IOException {
        if (event.getSource() instanceof ImageView) {
            ...
            switch (icon.getId()) {
                case "imgCustomer":
                    root = FXMLLoader.load(this.getClass().getResource("/lk/Ijse/pos/manage-customers-form.fxml"));
                    break;
                case "imgItem":
                    root = FXMLLoader.load(this.getClass().getResource("/lk/Ijse/pos/manage-items-form.fxml"));
                    break;
                case "imgOrder":
                    root = FXMLLoader.load(this.getClass().getResource("/lk/Ijse/pos/place-order-form.fxml"));
                    break;
                case "imgViewOrders":
                    root = null;
                    break;
